    ...
    public function admin_edit($id = null)
    {
        ...
        if (!empty($this->request->data)) {
            ...
            if (empty($errors)) {
                ...
                $this->Session->setFlash(__l('Commission Settings has been updated') , 'default', null, 'success');
            } else $this->Session->setFlash(__l(' Commission Settings could not be updated. Please, try again.') , 'default', null, 'error');
        } else {
