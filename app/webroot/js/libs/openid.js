(function () {
    function gen_selector() {
        ...
        var s;
        var providers = [{shortname: "Yahoo!", url_suffix: "", openid1: false, openid2: true, id: 15, icon: "yahoo.png", url_prefix: "http://me.yahoo.com/", website: "http://yahoo.com/", longname: "Yahoo!", usercalled: "yahoo id"}, {shortname: "myOpenID", url_suffix: ".myopenid.com/", openid1: true, openid2: true, id: 8, icon: "myopenid.png", url_prefix: "http://", website: "https://www.myopenid.com/", longname: "myOpenID", usercalled: "username"}, {shortname: "Google", url_suffix: "", openid1: false, openid2: true, id: 26, icon: "google.png", url_prefix: "", website: "https://www.google.com/accounts/o8/id", longname: "Google", usercalled: "username"}, {shortname: "Flickr", url_suffix: "", openid1: false, openid2: true, id: 6, icon: "flickr.png", url_prefix: "http://www.flickr.com/photos/", website: "http://www.flickr.com/", longname: "Flickr", usercalled: "username"}, {shortname: "AOL", url_suffix: "", openid1: true, openid2: false, id: 1, icon: "aol.png", url_prefix: "http://openid.aol.com/", website: "http://www.aol.com/", longname: "America Online/AIM", usercalled: "screenname"}, {shortname: "Blogger", url_suffix: ".blogspot.com/", openid1: true, openid2: false, id: 2, icon: "blogger.png", url_prefix: "http://", website: "http://www.blogger.com/", longname: "Google Blogger", usercalled: "blog name"}, {shortname: "Livejournal", url_suffix: ".livejournal.com/", openid1: true, openid2: false, id: 7, icon: "lj.png", url_prefix: "http://", website: "http://www.livejournal.com/", longname: "Livejournal", usercalled: "username"}, {shortname: "Verisign", url_suffix: ".pip.verisignlabs.com/", openid1: true, openid2: true, id: 11, icon: "verisign.png", url_prefix: "http://", website: "http://pip.verisignlabs.com/", longname: "Verisign PIP", usercalled: "username"}, {shortname: "Vidoop", url_suffix: ".myvidoop.com/", openid1: true, openid2: true, id: 12, icon: "vidoop2.png", url_prefix: "http://", website: "http://www.vidoop.com/", longname: "Vidoop", usercalled: "username"}, {shortname: "claimID", url_suffix: "", openid1: true, openid2: false, id: 4, icon: "claimid.png", url_prefix: "http://claimid.com/", website: "http://claimid.com/", longname: "claimID", usercalled: "username"}, {shortname: "Technorati", url_suffix: "", openid1: true, openid2: false, id: 10, icon: "technorati.png", url_prefix: "http://technorati.com/people/technorati/", website: "http://www.technorati.com/", longname: "Technorati", usercalled: "username"}, {shortname: "Vox", url_suffix: ".vox.com/", openid1: true, openid2: false, id: 13, icon: "vox.png", url_prefix: "http://", website: "http://www.vox.com/", longname: "Vox", usercalled: "username"}];
        ...
        arrow.src = __cfg('path_absolute') + "img/icons/arrow.gif";
	...
	btn.id = '__idselector_button';
        ...
        back.src = __cfg('path_absolute') + "img/icons/arrow_white_back.png";

        var forward = pdoc.createElement('img');
        forward.style.verticalAlign = "middle"; forward.style.cursor = "pointer";
        forward.src = __cfg('path_absolute') + "img/icons/arrow_white_forward.png";
        ...
        function Cell(grid, idx) {
            ...
            icon.src = provider ? (__cfg('path_absolute') + 'img/icons/' + provider.icon) :
                __cfg('path_absolute') + 'img/icons/openid.png';
        ...
        _.select = function (cell) {
            ...
            if (cell.idx > -1) {
                ...
                if (provider["openid2"] && !provider["openid1"]) {
                    ...
                    nameTb.style.backgroundImage = 'url('+__cfg('path_absolute') + 'img/icons/' + provider.icon + ')';
                    oidTb.value = provider.url_prefix + "username" +
                        provider.url_suffix;
                    nameTb.value = "username";
                }
                btnIcn.src = __cfg('path_absolute') + 'img/icons/' + provider.icon;
            } else {
                nameLabel.style.visibility = 'hidden';
                nameTb.style.visibility = 'hidden';
                btnIcn.src = __cfg('path_absolute') + 'img/icons/openid.png';
            }
        }
