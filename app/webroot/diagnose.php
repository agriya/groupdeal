        ...
        if ($db_selected) {
            ...
            if (!$result) {
				...
				$iphone_settings = array(
                    ...
                    'subscription.urbanairship_app_key',
					'subscription.iphone_apns_push_mail',
					'subscription.urbanairship_secret_key',
					'subscription.urbanairship_master_key',
					'subscription.iphone_certification_mode'
                );
                while ($row = mysql_fetch_assoc($result)) {
				...
				sort($db_info['settings']['iphone']['Mandatory']);
            }
            // ----------payment Gateway info get ------------------------------
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=groupdeal-pro-install#setting_up_files" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=groupdeal-pro-install#setting_up_files</a>
	</span>
</p>
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=groupdeal-pro-install#setting_up_database" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=groupdeal-pro-install#setting_up_database</a>
	</span>
</p>
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=groupdeal-pro-install#manage_settings" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=groupdeal-pro-install#manage_settings</a>
	</span>
</p>
<?php
