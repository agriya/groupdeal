<?php /* SVN: $Id: index.ctp 79538 2012-09-28 13:58:52Z rajeshkhanna_146ac10 $ */ ?>
				...
				<li class="<?php echo $select_class;?>">
					<?php
						if (Cache::read('site.city_url', 'long') == 'prefix'):
							echo $this->Html->link('<span class="grid_left">'.$this->Html->cText($city['City']['name']).'</span>'.'<span class="callout dc">'.$city['City']['active_deal_count'].'</span>', array('controller' => 'deals', 'action' => 'index', 'city' => $city['City']['slug'], 'admin' => false), array('escape' => false, 'class' => "$select_class",  'title' =>sprintf(__l('%s'),$city['City']['name'])));
