			...
			<li class="common-link clearfix">
				<div class="coupon-top-block clearfix">
				  ...
				  <span class="pending-approval">
					  <div class="js-pagination"><?php echo $this->Html->link(sprintf(__l('Pending (%s)'),$open),array('controller' => 'deal_users', 'action' => 'index', 'deal_id' => $deal_id, 'type' => 'open', 'deal_user_view' => $deal_user_view, 'view' => $view), array('title' => 'Pending-'.$deal_id)); ?></div>					
					</span>
				 ...
				 <li>
					...
					<ul class="coupon-canceled">
						...
						<span class="canceled">
							<div class="js-pagination"><?php echo $this->Html->link(sprintf(__l('Canceled (%s)'),$canceled),array('controller' => 'deal_users', 'action' => 'index', 'deal_id' => $deal_id, 'type' => 'canceled', 'deal_user_view' => $deal_user_view, 'view' => $view), array('title' => 'Canceled-'.$deal_id)); ?></div>
						</span>
						</li>
						</ul>
						</div>
				...
				<li>
					...
					<ul class="coupon-available">
						<li class="open clearfix">
    				        ...
    				        <div class="coupon-bottom-block clearfix">
    							<span class="open">
    							  <div class="js-pagination"><?php echo $this->Html->link(sprintf(__l('Available (%s)'),$available),array('controller' => 'deal_users', 'action' => 'index', 'deal_id' => $deal_id, 'type' => 'available', 'deal_user_view' => $deal_user_view, 'view' => $view), array('title' => 'Available-'.$deal_id)); ?></div>
    							</span>
    							<ul class="expired-block">
    								<li class="expired clearfix">
    									<span class="expired">
    										<div class="js-pagination"><?php echo $this->Html->link(sprintf(__l('Expired (%s)'),$expired),array('controller' => 'deal_users', 'action' => 'index', 'deal_id' => $deal_id, 'type' => 'expired', 'deal_user_view' => $deal_user_view, 'view' => $view), array('title' => 'Expired-'.$deal_id)); ?></div>
    									</span>
    								</li>
    								<li class="closed clearfix">
    									<span class="used">
    										<div class="js-pagination"><?php echo $this->Html->link(sprintf(__l('Used (%s)'),$used),array('controller' => 'deal_users', 'action' => 'index', 'deal_id' => $deal_id, 'type' => 'used', 'deal_user_view' => $deal_user_view, 'view' => $view), array('title' => 'Used-'.$deal_id)); ?></div>
    									</span>
    								</li>
    							</ul>
    							</div>
				   ...
				   <li>
					...
					<ul class="coupon-refunded">
						<li class="refunded clearfix">
						 ...
						 <span class="refunded">
						   <div class="js-pagination"><?php echo $this->Html->link(sprintf(__l('Refund (%s)'),$refund),array('controller' => 'deal_users', 'action' => 'index', 'deal_id' => $deal_id, 'type' => 'refund', 'deal_user_view' => $deal_user_view, 'view' => $view), array('title' => 'Refund-'.$deal_id)); ?>
						 </div>
						 </span>
						</li>
						</ul>
			...
			<div class="grid_right filter-list-info omega alpha">
				<ul class="clearfix filter-list">
					<?php if(!empty($deal_id)) {?>
						<li class="gifted"><div class="js-pagination"><?php echo $this->Html->link(sprintf(__l('Gifted (%s)'),$gifted_deals),array('controller' => 'deal_users', 'action' => 'index', 'deal_id' => $deal_id, 'type' => 'gifted_deals', 'deal_user_view' => $deal_user_view, 'view' => $view), array('title' => 'Gifted Coupons-'.$deal_id)); ?></div></li>
					<?php }else{ ?>
						<li class="gifted"><div class="js-pagination"><?php echo $this->Html->link(sprintf(__l('Gifted (%s)'),$gifted_deals),array('controller' => 'deal_users', 'action' => 'index', 'user_id' => $this->Auth->user('id'), 'type' => 'gifted_deals', 'deal_user_view' => $deal_user_view, 'view' => $view), array('title' => 'Gifted -'.$deal_id)); ?></div></li>
						<li class="received"><div class="js-pagination"><?php echo $this->Html->link(sprintf(__l('Received (%s)'),$recieved_gift), array('controller' => 'deal_users', 'action' => 'index', 'user_id' => $this->Auth->user('id'), 'type' => 'recieved_gift_deals', 'deal_user_view' => $deal_user_view, 'view' => $view), array('title' => 'Received -'.$deal_id)); ?></div></li>
					<?php }?>
					<li class="all"><div class="js-pagination"><?php echo $this->Html->link(sprintf(__l('All (%s)'),$all_deals),array('controller'=> 'deal_users','deal_id'=>$deal_id, 'action'=>'index','type' => 'all', 'deal_user_view' => $deal_user_view, 'view' => $view),array('title' => 'All-'.$deal_id)); ?></div></li>
				</ul>
			</div>
		</div>
	<?php } ?>
	...
	<div class="overflow-block">
		<table class="list">
			<tr>
				...
				<?php } ?>
                <?php if(($this->Auth->user('user_type_id') == ConstUserTypes::Company || $this->Auth->user('user_type_id') == ConstUserTypes::Admin) && !empty($deal_id)): ?>
				...
				<?php endif; ?>
				<th rowspan="2"><?php echo __l('Quantities x Price') . ' (' . Configure::read('site.currency') . ')';?></th>
				<th rowspan="2"><?php echo __l('Total') . ' (' . Configure::read('site.currency') . ')';?></th>
				<?php if (!empty($this->request->params['named']['type']) && ($this->request->params['named']['type'] == 'available' || $this->request->params['named']['type'] == 'used') ||  (!empty($show_coupon_code) && $deal_user_view == 'coupon')): ?>
					<?php if(($this->Auth->user('user_type_id') == ConstUserTypes::Company) ||  ($this->Auth->user('user_type_id') == ConstUserTypes::Admin)):?>
						<th colspan='2'><div class="js-pagination"><?php echo __l('Coupon code');?></div></th>
			...
			<?php if(($this->Auth->user('user_type_id') == ConstUserTypes::Company) ||  ($this->Auth->user('user_type_id') == ConstUserTypes::Admin) ||  ($this->Auth->user('user_type_id') == ConstUserTypes::User)):?>
				<?php if (!empty($this->request->params['named']['type']) && ($this->request->params['named']['type'] == 'available' || $this->request->params['named']['type'] == 'used') ||  (!empty($show_coupon_code) && $deal_user_view == 'coupon')): ?>
                    ...
                    <th><?php echo __l('Bottom Code') . '/' . __l('Top Code');?></th>
				<?php endif;?>
			<?php endif;?>	
			</tr>				
			<?php
			...
			<tr<?php echo $class;?>>
                ...
                <?php } ?>
				<td>
					<?php echo $this->Html->cDateTimeHighlight($dealUser['DealUser']['created']); ?>
					<?php 
						if(!empty($this->request->params['named']['type']) && ($this->request->params['named']['type'] == 'recieved_gift_deals')): ?>
							<p><span class="gift-info textb"><?php echo __l('Gift From') .':'; ?></span><?php echo $this->Html->cText($dealUser['DealUser']['gift_from']); ?></p>
					<?php	
						endif;
					?>
					<?php 
						if(!empty($this->request->params['named']['type']) && ($this->request->params['named']['type'] == 'gifted_deals')): ?>
							<p><span class="gift-info textb"><?php echo __l('Gift To') .':'; ?></span><?php echo $this->Html->cText($dealUser['DealUser']['gift_to']); ?></p>
					<?php 
						endif;
					?>
				</td>
				<?php if(!empty($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'canceled'): ?>
					<td><?php echo $this->Html->cDateTimeHighlight($dealUser['DealUser']['modified']);?></td>
				<?php endif;?>
                <?php if(($this->Auth->user('user_type_id') == ConstUserTypes::Company || $this->Auth->user('user_type_id') == ConstUserTypes::Admin) && !empty($deal_id)): ?>
				...
				<?php endif; ?>
				<td>
					<?php if(!empty($this->request->params['named']['type']) && ($this->request->params['named']['type']=='available' || $this->request->params['named']['type']=='expired')):?>
						<?php echo ($dealUser['DealUser']['quantity'] - $dealUser['DealUser']['deal_user_coupon_count'])  . ' x ' . $this->Html->cCurrency($dealUser['DealUser']['discount_amount']);?>
					<?php elseif(!empty($this->request->params['named']['type']) && $this->request->params['named']['type']=='used'):?>
						<?php echo $dealUser['DealUser']['deal_user_coupon_count']  . ' x ' . $this->Html->cCurrency($dealUser['DealUser']['discount_amount']);?>
					<?php else:?>
						<?php echo $dealUser['DealUser']['quantity'] . ' x ' . $this->Html->cCurrency($dealUser['DealUser']['discount_amount']); ?>
					<?php endif;?>
				</td>
				<td>
					<?php if(!empty($this->request->params['named']['type']) && ($this->request->params['named']['type']=='available' || $this->request->params['named']['type']=='expired')):?>
						<?php echo $this->Html->cCurrency((($dealUser['DealUser']['quantity'] - $dealUser['DealUser']['deal_user_coupon_count'])  * $dealUser['DealUser']['discount_amount']));?>
					<?php elseif(!empty($this->request->params['named']['type']) && $this->request->params['named']['type']=='used'):?>
						<?php echo $this->Html->cCurrency($dealUser['DealUser']['deal_user_coupon_count'] * $dealUser['DealUser']['discount_amount']);?>
					<?php else:?>
						<?php echo $this->Html->cCurrency($dealUser['DealUser']['quantity'] * $dealUser['DealUser']['discount_amount']); ?>
					<?php endif;?>
				</td>
				<?php if (!empty($this->request->params['named']['type']) && ($this->request->params['named']['type'] == 'available' || $this->request->params['named']['type'] == 'used') ||  (!empty($show_coupon_code) && $deal_user_view == 'coupon') ):?>
						<?php if(($this->Auth->user('user_type_id') == ConstUserTypes::Company) ||  ($this->Auth->user('user_type_id') == ConstUserTypes::Admin) ||  ($this->Auth->user('user_type_id') == ConstUserTypes::User)):?>
                                                 	...
                                                 	<?php
                                                            if(!empty($dealUserCoupon['is_used'])){
													     	...
													     	<span class="<?php echo 'status-'.$dealUserCoupon['is_used']?>">
																<span class="used-info"><?php echo $use_now; ?></span>
                                                                <?php  echo $this->Html->link(__l('Undo'), array('controller' => 'deal_user_coupons', 'action' => 'update_status', $dealUser['DealUser']['id'], 'coupon_id' => $dealUserCoupon['id'],'is_used', 'u' => 'index_deal_view'), array('class' => $class.' js-update-status','title' => $statusMessage)); ?>
                                                                </span>
                                                                </li>
                                                                <?php }
															...
															<?php }
																...
																if(!empty($dealUser['Deal']['coupon_start_date'])):
                                                                  ...
                                                                  <li>
													        	    <span class="<?php echo 'status-'.$dealUserCoupon['is_used']?>">
																	<?php echo $this->Html->link($use_now, array('controller' => 'deal_user_coupons', 'action' => 'update_status', $dealUser['DealUser']['id'], 'u' => 'index_deal_view'), array('class' => $class.' '.$confirmation_message.' js-update-status','title' => $statusMessage)); ?>
																	</span>
																	</li>
                                                                    <?php
																	endif;
													...
													<?php if ($class == 'not-used')  { ?>
														...
														<?php
                                                           ...
                                                           <li>
													     	<span class="<?php echo 'status-'.$dealUserCoupon['is_used']?>">
                                                                <?php echo $use_now;
															    echo $this->Html->link(__l('Undo'), array('controller' => 'deal_user_coupons', 'action' => 'update_status', $dealUser['DealUser']['id'], 'coupon_id' => $dealUserCoupon['id'], 'is_used', 'u' => 'index_deal_view'), array('class' => $class.' '.$confirmation_message.' js-update-status', 'title' => $statusMessage));
															    ?>
															    </span>
															    </li>
														<?php }else { ?>
															...
															<?php
																 if(!empty($dealUser['Deal']['coupon_start_date'])):
																	if((date('Y-m-d H:i:s') >= _formatDate('Y-m-d H:i:s', strtotime($dealUser['SubDeal']['coupon_start_date'])) && date('Y-m-d H:i:s') <= _formatDate('Y-m-d H:i:s', strtotime($dealUser['Deal']['coupon_expiry_date']))) || (date('Y-m-d H:i:s') >= _formatDate('Y-m-d H:i:s', strtotime($dealUser['Deal']['coupon_start_date'])) && empty($dealUser['Deal']['coupon_expiry_date'])) || (date('Y-m-d H:i:s') >= _formatDate('Y-m-d H:i:s', strtotime($dealUser['SubDeal']['coupon_start_date'])) && date('Y-m-d H:i:s') <= _formatDate('Y-m-d H:i:s', strtotime($dealUser['SubDeal']['coupon_expiry_date'])) && $dealUser['Deal']['is_now_deal'] == 1)):
																       ...
																       <li>
													     	            <span class="<?php echo 'status-'.$dealUserCoupon['is_used']?>">
                                                                        <?php echo $this->Html->link($use_now, array('controller' => 'deal_user_coupons', 'action' => 'update_status', $dealUser['DealUser']['id'], 'coupon_id' => $dealUserCoupon['id'], 'is_used', 'u' => 'index_deal_view'), array('class' => $class.' '.$confirmation_message.' js-update-status', 'title' => $statusMessage)); ?>
												                    	</span>
																		</li>
                                                                     <?php } ?>
					                 								<?php
									...
									<?php if ((!empty($coupon_find_id) && in_array($dealUserCoupon['id'], $coupon_find_id)) || (!empty($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'available' && empty($dealUserCoupon['is_used'])) || (!empty($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'used' && !empty($dealUserCoupon['is_used'])) ||  (!empty($show_coupon_code) && $deal_user_view == 'coupon')) { ?>
										<li class="clearfix">
                                        	<?php if(Configure::read('deal.deal_coupon_used_type') == 'click'){ ?>
														<span class="coupon-code"><?php echo $dealUserCoupon['unique_coupon_code'] . '/' . $dealUserCoupon['coupon_code']; ?></span>
                                            <?php } else { ?>
												 <?php  
												 	if( $this->Auth->user('user_type_id') == ConstUserTypes::Company ){
														if( Configure::read('deal.deal_coupon_code_show_type') == 'top' ||  Configure::read('deal.deal_coupon_code_show_type') == 'bottom') {
