...
<table class="list">
    <tr>
        ...
        <th><?php echo __l('Commission Earned');?></th>
...
?>
	<tr<?php echo $class;?>>
		...
		<td> <?php echo $this->Html->link($this->Html->cText($referred_user_earned['User']['username']), array('controller'=> 'users', 'action'=>'view', $referred_user_earned['User']['username'], 'admin' => false), array('escape' => false));?></td>
