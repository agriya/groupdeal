...
<?php 	echo $this->Form->create('Deal', array('action' => 'subdeal_add', 'class' => 'normal add-live-form'));
...
<div class="submit-block clearfix">
	...
	<?php
		...
		echo $this->Form->submit(__l('Save as Draft'), array('name' => 'data[Deal][save_as_draft]', 'class' => 'js-update-order-field grid_1')); 
	?>
</div>
<?php
	echo $this->Form->end();
